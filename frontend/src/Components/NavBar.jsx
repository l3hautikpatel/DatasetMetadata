  ...
  return (
    <>
        ...
        <a href="https://flowbite.com/" className="flex items-center space-x-3 rtl:space-x-reverse">
            <img src="https://images.squarespace-cdn.com/content/v1/64e4e29725c04b3719d055ad/1692721851024-TQQ4RCABD66UNB4R5DW8/image-asset.png" className="h-8" alt="Metapool Logo" />
            <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">MetaPool</span>
        </a>
